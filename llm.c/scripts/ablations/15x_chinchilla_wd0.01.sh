...
torchrun --standalone --nproc_per_node=4 train_gpt2.py  \
    --input_bin "/mnt/qb/luxburg/sbordt10/datasets/fineweb-edu-sample-37.5BT-contaminated-token-scaling/fineweb-edu_train_*.bin" \
    ...
    --exp_name "124M_15x_wd0.01" \
    --resume_from_checkpoint "/mnt/qb/luxburg/sbordt10/chkpts/124M_15x_wd0.01/gpt=d12_step=42921.pth" \
