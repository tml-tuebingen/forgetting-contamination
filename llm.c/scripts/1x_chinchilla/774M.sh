...
torchrun --standalone --nproc_per_node=4 train_gpt2.py  \
    --input_bin "/mnt/qb/luxburg/sbordt10/datasets/fineweb-edu-sample-15.5BT-contaminated/fineweb-edu_train_*.bin" \
    ...
    --resume_from_checkpoint "/mnt/qb/luxburg/sbordt10/chkpts/774M_15.5B/gpt=d36_step=27500.pth" \
